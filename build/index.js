...
"use strict";
eval("\nexports.__esModule = true;\nvar nodecron = __webpack_require__(/*! node-cron */ \"node-cron\");\nvar schema_1 = __webpack_require__(/*! ./schema */ \"./src/utils/schema.ts\");\nvar feed_worker_1 = __webpack_require__(/*! ./feed.worker */ \"./src/utils/feed.worker.ts\");\nvar logger_1 = __webpack_require__(/*! ./logger */ \"./src/utils/logger.ts\");\nvar CronJobs = /** @class */ (function () {\n    function CronJobs(worker_queue) {\n        var _this = this;\n        this.setupJobs = function () {\n            _this.cron.schedule(\"* * * * *\", function () { return _this.updateFeeds(); });\n        };\n        this.updateFeeds = function () {\n            _this.logger.info(\"Running cron Job: FeedUpdate\");\n            schema_1.Feed.find({}).exec(function (err, data) {\n                if (data.length) {\n                    data.forEach(function (feed_item) {\n                        console.log(\"item\", feed_item);\n                        console.log(feed_item.url);\n                        var feed_worker = new feed_worker_1[\"default\"](\"worker\", feed_item.url);\n                        _this.worker_queue.add_worker(feed_worker);\n                    });\n                }\n            });\n        };\n        this.worker_queue = worker_queue;\n        this.cron = nodecron;\n        this.logger = new logger_1[\"default\"]();\n    }\n    return CronJobs;\n}());\nexports[\"default\"] = CronJobs;\n\n\n//# sourceURL=webpack:///./src/utils/cronjobs.ts?");
